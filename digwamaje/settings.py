...
STATICFILES_DIRS = []  # Leave this empty unless you have additional directories to include

# Optional: If you're deploying, make sure to set caching headers as needed
